...
// Dicionário com os dados estatíticos carregados pela view do Django
const js_statistics = JSON.parse(document.getElementById('js_statistics').textContent);
...
function floatchart() {
    ...
    (function () {
        ...
        var options = {
            ...
            labels: ['Atualizados', 'Atualizar'],
            series: [js_statistics["pedidos_atualizados"], js_statistics["pedidos_atualizar"]],
            legend: {
                show: false
            },
            tooltip: {
        ...
        var options1 = {
            ...
            labels: ['Regional', 'Centralizado'],
            series: [js_statistics.pedidos_regional, js_statistics.pedidos_centralizado],
            legend: {
                show: false
            },
            tooltip: {
    ...
    (function () {
        var options = {
            ...
            series: [{
                name: 'Entrante Comercial',
                data: js_statistics.entrante_7_dias,
            }, {
                name: 'Atualizações',
                data: js_statistics.atualizados_7_dias,
            }],
            legend: {
                position: 'top',
            },
            xaxis: {
                type: 'category',
                categories: js_statistics.datas_7_dias,
                axisBorder: {
                    show: false,
                },
                label: {
