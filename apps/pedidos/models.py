...
class Pedido(models.Model):
    ...
    def get_absolute_url(self):
        return reverse("apps_Pedido_detail", args=(self.pk,))

    def get_update_url(self):
        return reverse("apps_Pedido_update", args=(self.pk,))

    @staticmethod
    def get_htmx_create_url():
        return reverse("apps_Pedido_htmx_create")

    def get_htmx_delete_url(self):
        return reverse("apps_Pedido_htmx_delete", args=(self.pk,))
