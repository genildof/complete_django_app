...
class HTMXPedidoListView(generic.ListView):
    model = models.Pedido
...
class HTMXPedidoCreateView(generic.CreateView):
    model = models.Pedido
    form_class = forms.PedidoForm
...
class HTMXPedidoDeleteView(generic.DeleteView):
    model = models.Pedido
    success_url = reverse_lazy("apps_Pedido_htmx_list")
